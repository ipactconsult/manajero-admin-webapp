...
@Component({
  selector: 'ngx-archived-journal-list',
  templateUrl: './archived-journal-list.component.html',
  styleUrls: ['./archived-journal-list.component.scss']
})
export class ArchivedJournalListComponent implements OnInit {
