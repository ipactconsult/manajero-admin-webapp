...
@Component({
  selector: 'ngx-purchase-returns-grid',
  templateUrl: './purchase-returns-grid.component.html',
  styleUrls: ['./purchase-returns-grid.component.scss']
})
export class PurchaseReturnsGridComponent implements OnInit {
