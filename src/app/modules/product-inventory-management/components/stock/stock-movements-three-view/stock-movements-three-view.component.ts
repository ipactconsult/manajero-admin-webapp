...
@Component({
  selector: 'ngx-stock-movements-three-view',
  templateUrl: './stock-movements-three-view.component.html',
  styleUrls: ['./stock-movements-three-view.component.scss']
})
export class StockMovementsThreeViewComponent implements OnInit {
