...
@Component({
  selector: 'ngx-stock-entries-list',
  templateUrl: './stock-entries-list.component.html',
  styleUrls: ['./stock-entries-list.component.scss']
})
export class StockEntriesListComponent implements OnInit {
