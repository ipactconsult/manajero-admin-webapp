...
@Component({
  selector: 'ngx-inventory-movements-grid',
  templateUrl: './inventory-movements-grid.component.html',
  styleUrls: ['./inventory-movements-grid.component.scss']
})
export class InventoryMovementsGridComponent implements OnInit {
