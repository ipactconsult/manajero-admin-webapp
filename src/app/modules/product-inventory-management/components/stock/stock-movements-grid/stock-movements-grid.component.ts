...
@Component({
  selector: 'ngx-stock-movements-grid',
  templateUrl: './stock-movements-grid.component.html',
  styleUrls: ['./stock-movements-grid.component.scss']
})
export class StockMovementsGridComponent implements OnInit {
