...
@Component({
  selector: 'ngx-stock-exits-list',
  templateUrl: './stock-exits-list.component.html',
  styleUrls: ['./stock-exits-list.component.scss']
})
export class StockExitsListComponent implements OnInit {
