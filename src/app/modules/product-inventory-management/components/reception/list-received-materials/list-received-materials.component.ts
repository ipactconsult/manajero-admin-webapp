...
@Component({
  selector: 'ngx-list-received-materials',
  templateUrl: './list-received-materials.component.html',
  styleUrls: ['./list-received-materials.component.scss']
})
export class ListReceivedMaterialsComponent implements OnInit {
  ...
  stockMaterialW(material: Material, warehouse: Warehouse, ref): void {
    this.stockMovement = {
      ...
      stateSM: 'In',
      smCode: ListReceivedMaterialsComponent.getRandomNumberSM(100000, 999999)
    };
    this.stockEntry = {
      material: material,
      quantityIn: material.materialQuantity,
      stockEntryRef: ListReceivedMaterialsComponent.getRandomNumber(100000, 999999)
    };
