...
@Component({
  selector: 'ngx-grid-received-materials',
  templateUrl: './grid-received-materials.component.html',
  styleUrls: ['./grid-received-materials.component.scss']
})
export class GridReceivedMaterialsComponent implements OnInit {
  ...
  stockMaterialW(material: Material, warehouse: Warehouse, ref): void {
    this.stockMovement = {
      ...
      stateSM: 'In',
      smCode: GridReceivedMaterialsComponent.getRandomNumberSM(100000, 999999)
    };
    this.stockEntry = {
      material: material,
      quantityIn: material.materialQuantity,
      stockEntryRef: GridReceivedMaterialsComponent.getRandomNumber(100000, 999999)
    };
