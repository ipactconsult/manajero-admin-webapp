...
@Component({
  selector: 'ngx-grid-suppliers',
  templateUrl: './grid-suppliers.component.html',
  styleUrls: ['./grid-suppliers.component.scss']
})
export class GridSuppliersComponent implements OnInit {
