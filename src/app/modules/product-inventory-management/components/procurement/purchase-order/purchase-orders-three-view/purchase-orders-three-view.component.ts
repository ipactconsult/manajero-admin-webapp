...
@Component({
  selector: 'ngx-purchase-orders-three-view',
  templateUrl: './purchase-orders-three-view.component.html',
  styleUrls: ['./purchase-orders-three-view.component.scss']
})
export class PurchaseOrdersThreeViewComponent implements OnInit {
