...
@Component({
  selector: 'ngx-grid-materials',
  templateUrl: './grid-materials.component.html',
  styleUrls: ['./grid-materials.component.scss']
})
export class GridMaterialsComponent implements OnInit {
