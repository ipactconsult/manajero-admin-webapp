...
@Component({
  selector: 'ngx-pdfcall',
  templateUrl: './pdfcall.component.html',
  styleUrls: ['./pdfcall.component.scss']
})
export class PdfcallComponent implements OnInit {
  ...
  table(data: any, columns: any, header: any,width: any[]) {
   ...
   generatePdf() {
    ...
    const Listmail=this?.relances?.call
