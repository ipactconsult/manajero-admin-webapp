...
@Component({
  selector: 'ngx-pdfcomment',
  templateUrl: './pdfcomment.component.html',
  styleUrls: ['./pdfcomment.component.scss']
})
export class PdfcommentComponent implements OnInit {
  id: string;
  ...
  table(data: any, columns: any, header: any,width: any[]) {
   ...
   generatePdf() {
    ...
    const Listmail=this?.relances?.comment
