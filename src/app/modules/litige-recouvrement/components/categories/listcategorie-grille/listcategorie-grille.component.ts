...
@Component({
  selector: 'ngx-listcategorie-grille',
  templateUrl: './listcategorie-grille.component.html',
  styleUrls: ['./listcategorie-grille.component.scss']
})
export class ListcategorieGrilleComponent implements OnInit {
