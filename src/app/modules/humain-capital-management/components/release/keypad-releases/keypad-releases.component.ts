...
@Component({
  selector: 'ngx-keypad-releases',
  templateUrl: './keypad-releases.component.html',
  styleUrls: ['./keypad-releases.component.scss']
})
export class KeypadReleasesComponent implements OnInit {
