...
@Component({
  selector: 'ngx-grid-applications',
  templateUrl: './grid-applications.component.html',
  styleUrls: ['./grid-applications.component.scss']
})
export class GridApplicationsComponent implements OnInit {
