...
@Component({
  selector: 'ngx-grid-sub-department',
  templateUrl: './grid-sub-department.component.html',
  styleUrls: ['./grid-sub-department.component.scss']
})
export class GridSubDepartmentComponent implements OnInit {
