...
@Component({
  selector: 'ngx-keypad-skills',
  templateUrl: './keypad-skills.component.html',
  styleUrls: ['./keypad-skills.component.scss']
})
export class KeypadSkillsComponent implements OnInit {
